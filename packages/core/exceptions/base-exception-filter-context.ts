import { FILTER_CATCH_EXCEPTIONS } from '@nestjs-client/common/constants';
import { Type } from '@nestjs-client/common/interfaces';
import { ExceptionFilter } from '@nestjs-client/common/interfaces/exceptions/exception-filter.interface';
